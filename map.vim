...
map <C-K> :pyf /usr/local/Cellar/clang-format/2018-01-11/bin/clang-format.py<cr>
imap <C-K> <c-o>:pyf /usr/local/Cellar/clang-format/2018-01-11/bin/clang-format.py<cr>
